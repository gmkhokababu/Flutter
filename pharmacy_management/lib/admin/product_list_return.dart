...
class ProductListReturn extends StatefulWidget {
  const ProductListReturn({super.key});


  @override
  State<ProductListReturn> createState() => _ProductListReturnState();
}
...
class _ProductListReturnState extends State<ProductListReturn> {
  ...
  Future<List<PReport>> navigate(value){
    if(value!=null) {
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  AllProductListReturn(allproduct: value,)
          ));
      return value;
    }else{
      return value;
